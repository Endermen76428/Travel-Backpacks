...
const scriptEventFunctions: { [jey: string]: (message: string, entity?: Entity, block?: Block) => void } = {
  ...
  "travel_backpack:archive": (message, entity) => {
    ...
    const pos = {x: entity.location.x, y: entity.dimension.heightRange.min, z: entity.location.z}
    entity.teleport(pos)
    world.structureManager.delete(id)
    world.structureManager.createFromWorld(id, entity.dimension, pos, pos, {includeBlocks: false, saveMode: StructureSaveMode.World})
    entity.remove()
  },
